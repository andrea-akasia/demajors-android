package com.demajors.demajorsapp.feature.detailpokemon

import android.graphics.Color
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.demajors.demajorsapp.databinding.ViewPokemonTypeBinding
import com.demajors.demajorsapp.model.api.detailpokemon.TypesItem
...
class TypeAdapter(val data: List<TypesItem>) : RecyclerView.Adapter<TypeAdapter.TypeHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TypeHolder {
        return TypeHolder(
            ViewPokemonTypeBinding.inflate(
